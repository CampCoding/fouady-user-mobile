...
import { ForgetPasswordScreenProps } from './ForgetPasswordScreen.types';
import { SafeAreaView } from 'react-native-safe-area-context';
import Ionicons from '@react-native-vector-icons/ionicons';
import { colors } from '../../../theme';

const ForgetPasswordScreenUI = (props: ForgetPasswordScreenProps) => {
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.foreground }}>
      ...
      <View style={[styles.container, { padding: 20 }]}>
        ...
        <Text style={{ color: colors.white }}>ForgetPassword Screen</Text>
      </View>
    </SafeAreaView>
  );
};

export default ForgetPasswordScreenUI;
